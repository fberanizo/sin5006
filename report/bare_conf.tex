...
\begin{figure*}[!t]
\centering
\subfloat[Fig. 3: Evolução do algorítimo genético para f0(x) c/ s s/elitismo]{\includegraphics[width=5.0in]{f0_elitism}%
\label{fig_first_case}}
\hfil
\subfloat[Fig. 4: Evolução do algorítimo genético para f3(x) c/ mutação simples e permutação]{\includegraphics[width=5.0in]{f3_permutation}%
