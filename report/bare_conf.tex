...
analisar o comportamento do algorítmo genético mediante a utilização de 
diferentes técnicas, operadores e parametrizações.\\
O trabalho foi desenvolvido utilizando-se a linguagem de programação Python,
