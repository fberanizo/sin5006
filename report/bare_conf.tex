...
Foi analisado somente um operador de seleção de indivíduos neste trabalho. O 
método da roleta foi escolhido por ser de fácil implementação e por apresentar
bons resultados segundo a literatura. No entanto, durante o desenvolvimento foi
possível perceber que este operador aumenta o tempo de execução do algorítmo 
para grandes populações, uma vez que todos os indivíduos participam do sorteio.
...
genéticos: reprodução, crossover e mutação. \\
