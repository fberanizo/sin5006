...
class SineXSquareRoot(unittest.TestCase):
    ...
    #     filepath ='/home/fabio/sin5006/tests/results/sinexsquareroot/test_grid_search_100_generations.csv'
    #     utils.save_scores(filepath, grid_scores)

    #     sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_grid_search_100_generations.csv\n")
    #     assert True
    ...
    #     filepath ='/home/fabio/sin5006/tests/results/sinexsquareroot/test_grid_search_1_second.csv'
    #     utils.save_scores(filepath, grid_scores)

    #     sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_grid_search_1_second.csv\n")
    #     assert True
    ...
    def test_base(self):
        ...
        for idx in xrange(repeat):
            individual_factory = optimization.SineXSquareRootFloatIndividualFactory(crossover_method='one_point', mutation_method='basic_mutation')
            termination_criteria = ga.NumberOfGenerationsTerminationCriteria(number_of_generations=100)
        ...
        info.to_csv('/home/fabio/sin5006/tests/results/sinexsquareroot/test_base.csv', sep=',', index=False)
        ...
        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_base.csv\n")
        assert True
    ...
    def test_elitism(self):
        ...
        info.to_csv('/home/fabio/sin5006/tests/results/sinexsquareroot/test_elitism.csv', sep=',', index=False)

        base = pandas.read_csv('/home/fabio/sin5006/tests/results/sinexsquareroot/test_base.csv')
        ...
        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_elitism.csv\n")
        assert True
    ...
    def test_uniform_crossover(self):
        ...
        individual_factory = optimization.SineXSquareRootFloatIndividualFactory(crossover_method='uniform', mutation_method='basic_mutation')
        termination_criteria = ga.NumberOfGenerationsTerminationCriteria(number_of_generations=100)
        solver = ga.GeneticAlgorithm(individual_factory, population_size=population_size, reproduction=reproduction, crossover=crossover, mutation=mutation, elitism=False, termination_criteria=termination_criteria)
        ...
        info.to_csv('/home/fabio/sin5006/tests/results/sinexsquareroot/test_uniform_crossover.csv', sep=',', index=False)
        ...
        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_uniform_crossover.csv\n")
        assert True
    ...
    def test_permutation_mutation(self):
        ...
        individual_factory = optimization.SineXSquareRootFloatIndividualFactory(crossover_method='one_point', mutation_method='permutation')
        termination_criteria = ga.NumberOfGenerationsTerminationCriteria(number_of_generations=100)
        solver = ga.GeneticAlgorithm(individual_factory, population_size=population_size, reproduction=reproduction, crossover=crossover, mutation=mutation, elitism=False, termination_criteria=termination_criteria)
        ...
        info.to_csv('/home/fabio/sin5006/tests/results/sinexsquareroot/test_permutation_mutation.csv', sep=',', index=False)
        ...
        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/sinexsquareroot/test_permutation_mutation.csv\n")
        assert True
