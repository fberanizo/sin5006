...
class XSquare(unittest.TestCase):
    ...
    def test_case2(self):
        ...
        filepath ='/home/fabio/sin5006/tests/results/xsquare/test_case2.csv'
        utils.save_scores(filepath, grid_scores)
        dataset = pandas.pivot_table(pandas.read_csv(filepath), index='Operators', columns='Population', values='Fitness', aggfunc=numpy.sum)
        utils.plot_heatmap('/home/fabio/sin5006/tests/results/xsquare/test_case2_hm.png', dataset)

        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/xsquare/test_case2.csv\n")
        assert True
    ...
    def test_case3(self):
        ...
        solver = ga.GeneticAlgorithm(optimization.XSquareFloatIndividualFactory(crossover_method='uniform', mutation_method='basic_mutation'))
        grid = grid_search.GridSearch(solver, params)
        grid.search(0.0)
        grid_scores = grid.get_grid_scores()

        filepath = '/home/fabio/sin5006/tests/results/xsquare/test_case3.csv'
        utils.save_scores(filepath, grid_scores)
        dataset = pandas.pivot_table(pandas.read_csv(filepath), index='Operators', columns='Population', values='Fitness', aggfunc=numpy.sum)
        utils.plot_heatmap('/home/fabio/sin5006/tests/results/xsquare/test_case3_hm.png', dataset)

        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/xsquare/test_case3.csv\n")
        assert True
    ...
    def test_case4(self):
        ...
        solver = ga.GeneticAlgorithm(optimization.XSquareFloatIndividualFactory(crossover_method='one-point', mutation_method='permutation'))
        grid = grid_search.GridSearch(solver, params)
        grid.search(0.0)
        grid_scores = grid.get_grid_scores()

        filepath = '/home/fabio/sin5006/tests/results/xsquare/test_case4.csv'
        utils.save_scores(filepath, grid_scores)
        dataset = pandas.pivot_table(pandas.read_csv(filepath), index='Operators', columns='Population', values='Fitness', aggfunc=numpy.sum)
        utils.plot_heatmap('/home/fabio/sin5006/tests/results/xsquare/test_case4_hm.png', dataset)

        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/xsquare/test_case4.csv\n")
        assert True
    ...
    def test_case5(self):
        ...
        filepath = '/home/fabio/sin5006/tests/results/xsquare/test_case5.csv'
        utils.save_scores(filepath, grid_scores)
        dataset = pandas.pivot_table(pandas.read_csv(filepath), index='Operators', columns='Population', values='Fitness', aggfunc=numpy.sum)
        utils.plot_heatmap('/home/fabio/sin5006/tests/results/xsquare/test_case5_hm.png', dataset)

        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/xsquare/test_case5.csv\n")
        assert True
    ...
    def test_case6(self):
        ...
        solver = ga.GeneticAlgorithm(optimization.XSquareBinaryIndividualFactory(crossover_method='one_point', mutation_method='basic_mutation'))
        grid = grid_search.GridSearch(solver, params)
        grid.search(0.0)
        grid_scores = grid.get_grid_scores()

        filepath ='/home/fabio/sin5006/tests/results/xsquare/test_case6.csv'
        utils.save_scores(filepath, grid_scores)
        dataset = pandas.pivot_table(pandas.read_csv(filepath), index='Operators', columns='Population', values='Fitness', aggfunc=numpy.sum)
        utils.plot_heatmap('/home/fabio/sin5006/tests/results/xsquare/test_case6_hm.png', dataset)

        sys.stdout.write("Finished. Results are at: /home/fabio/sin5006/tests/results/xsquare/test_case6.csv\n")
        assert True
